    ...
    {pathname.includes("profile") && <PiDotsThree onClick={()=>{setOpen(true);setTimeout(() => { setOpen(false) }, 5000);
      ...
      { pathname === "/friends" &&
        (<div className="flex flex-col gap-1 items-center ">
          ...
          <span className=" bg-sky-900 hover:bg-gray-800 hover:cursor-pointer px-1 w-full py-1 text-white rounded-xl text-center font-mono  text-[9px]"> Add Friend</span>
        </div>) }
       </div>
   )
}
