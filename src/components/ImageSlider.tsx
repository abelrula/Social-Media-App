...
import { Stories } from "../lib/data";
 function ImageSlider({currentIndex, setCurrentIndex}) {
  ...
  return (
    <div className="!bg-[#FCF6F5]  flex gap-4 items-center justify-around   h-screen w-full m-auto py-16 px-4 relative group bg  ">
      <div style={{ backgroundImage: `url(${next.image})` ,width:"300px",height:"400px" }}
        className="relative rounded-2xl brightness-50 ounded-2xl bg-center bg-cover duration-500">
      <div className="absolute  w-full p-3 top-0  flex gap-4">
      ...
      <time className="text-xs text-white">20 hours ago</time>
        ...
        <div style={{ backgroundImage: `url(${stories[currentIndex].image})` ,width:"450px",height:"550px" }}
      ...
      <time className="text-xs text-[white]">20 hours ago</time>
        ...
        <div style={{ backgroundImage: `url(${prev.image})` ,width:"300px",height:"400px" }}
